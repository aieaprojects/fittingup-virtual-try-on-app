...
```bash
git remote add encore encore://fittingup-virtual-try-on-app-qoc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fittingup-virtual-try-on-app-qoc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fittingup-virtual-try-on-app-qoc2/settings/integrations/github)
